    ...
    tabItems(
      ...
      tabItem(tabName = "d",
              tabPanel("Documentation",
                       #downloadButton('downloadDocs', 'Download Vignette'),
                       br(),
...
#     filename = "clusterProfiler_GOAnalysis_Vignette.html",
#     content = function(file) {
#       file.copy(from="/data/manke/group/shiny/ferrari/clusterProfiler_GOenrich/ShinyApp_documentation/Documentation_ShinyApp_clusterProfiler.html", to=file, overwrite = T)
#     }
#   )
#   
#   
